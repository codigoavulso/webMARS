...
//Richiede C1-NATIVE: argc/argv nativo, array di caratteri con indirizzo a byte
//e chiama tramite un puntatore a funzione.
//Abilita gli argomenti del programma in Impostazioni e prova: mul
//webMARS argv[0] è il primo token fornito, non un nome eseguibile.
