#MARS-OS 1.0 - un ambiente operativo TTY interattivo e completo
#Apri Strumenti > TTY Dispositivo + ANSI Terminale, connettiti a MIPS,
#assemblare e correre; apre il desktop del mouse. Avvia Terminal per la shell.
#
#Questo file contiene solo il testo localizzato. Il kernel stesso vive
#i moduli linguistici neutri inclusi in basso:
#mips_os_lib.asm TTY driver, ANSI controllo, stringhe, numeri interi
#mips_os_fs.asm filesystem RAM scrivibile e relativi comandi
#mips_os_apps.asm calcolatrice, banner, calendario, giochi
#mips_os_edit.asm editor di testo a schermo intero
#mips_os_sheet.asm foglio di calcolo a schermo intero
#mips_os_basic.asm riga numerata intera BASIC interprete
#mips_os_desktop.asm Program Manager e Windows guidati dal mouse
#mips_os_kernel.asm comandi di avvio, shell e sistema
...
#---- desktop con finestra ----
#Titoli della barra dei menu e voci di menu. Il desktop presenta i menu da
#queste stringhe, quindi una traduzione più lunga non fa altro che allargare il menu.
...
#Titoli delle finestre, indicizzati per tipo di finestra.
...
#---- immagine del disco dell'ora di avvio ----
#Ogni blocco utilizza semplici ritorni a capo: il disco RAM memorizza testo semplice e il
#il driver della console è ciò che trasforma un ritorno a capo in CR più LF in uscita.
