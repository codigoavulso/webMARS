...
read_line_regular:
  #32개 미만의 제어 문자를 무시합니다.
  li   $t0, 32
  slt  $t1, $s4, $t0
  bne  $t1, $zero, read_line_loop
  nop

  #0을 종료하기 위해 1바이트를 유지합니다.
  addiu $t0, $s2, -1
  slt  $t1, $s3, $t0
