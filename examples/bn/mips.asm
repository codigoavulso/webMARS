...
#mips_os_lib.asm TTY ড্রাইভার, ANSI নিয়ন্ত্রণ, স্ট্রিং, পূর্ণসংখ্যা
#mips_os_fs.asm লেখার যোগ্য RAM ফাইল সিস্টেম এবং এর কমান্ড
#mips_os_apps.asm ক্যালকুলেটর, ব্যানার, ক্যালেন্ডার, গেমস
#mips_os_edit.asm পূর্ণ স্ক্রীন পাঠ্য সম্পাদক
#mips_os_sheet.asm পূর্ণ স্ক্রীন স্প্রেডশীট
#mips_os_basic.asm লাইন সংখ্যাযুক্ত পূর্ণসংখ্যা BASIC দোভাষী
#mips_os_desktop.asm মাউস চালিত প্রোগ্রাম ম্যানেজার এবং উইন্ডোজ
#mips_os_kernel.asm বুট, শেল এবং সিস্টেম কমান্ড
...
#---- বুট টাইম ডিস্ক ইমেজ ----
#প্রতিটি ব্লক বেয়ার নিউলাইন ব্যবহার করে: RAM ডিস্ক প্লেইন টেক্সট সংরক্ষণ করে এবং
#কনসোল ড্রাইভার হল যা একটি নতুন লাইনকে সিআর প্লাস এলএফ-এ পরিণত করে।
