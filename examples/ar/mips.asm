...
#mips_os_lib.asm TTY برنامج التشغيل، التحكم ANSI، السلاسل، الأعداد الصحيحة
#mips_os_fs.asm نظام الملفات القابل للكتابة RAM وأوامره
#mips_os_apps.asm آلة حاسبة، لافتة، تقويم، ألعاب
#mips_os_edit.asm محرر نصوص ملء الشاشة
#mips_os_sheet.asm جدول بيانات بملء الشاشة
#mips_os_basic.asm سطر عدد صحيح BASIC مترجم
#mips_os_desktop.asm مدير البرامج والنوافذ الذي يحركه الماوس
#mips_os_kernel.asm أوامر التمهيد والصدفة والنظام
...
#---- صورة قرص وقت التمهيد ----
#تستخدم كل كتلة أسطرًا جديدة مجردة: يقوم القرص RAM بتخزين نص عادي و
#برنامج تشغيل وحدة التحكم هو ما يحول السطر الجديد إلى CR بالإضافة إلى LF عند الخروج.
