...
//Memerlukan C1-NATIVE: argc/argv asli, array char beralamat byte
//dan memanggil melalui penunjuk fungsi.
//Aktifkan argumen program di Pengaturan dan coba: mul
//webMARS argv[0] adalah token pertama yang diberikan, bukan nama yang dapat dieksekusi.
