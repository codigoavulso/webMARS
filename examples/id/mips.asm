...
#mips_os_lib.asm TTY driver, ANSI kontrol, string, bilangan bulat
#mips_os_fs.asm sistem file RAM yang dapat ditulis dan perintahnya
#mips_os_apps.asm kalkulator, spanduk, kalender, permainan
#mips_os_edit.asm editor teks layar penuh
#mips_os_sheet.asm spreadsheet layar penuh
#mips_os_basic.asm baris bernomor bilangan bulat BASIC juru bahasa
#mips_os_desktop.asm Manajer Program dan jendela yang digerakkan oleh mouse
#mips_os_kernel.asm boot, shell dan perintah sistem
...
#---- waktu boot gambar disk ----
#Setiap blok menggunakan baris baru: disk RAM menyimpan teks biasa dan
#driver konsol inilah yang mengubah baris baru menjadi CR plus LF saat keluar.
