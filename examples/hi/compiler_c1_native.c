...
//C1-NATIVE की आवश्यकता है: मूल argc/argv, बाइट-संबोधित चार सरणियाँ
//और एक फ़ंक्शन पॉइंटर के माध्यम से कॉल करता है।
//सेटिंग्स में प्रोग्राम तर्क सक्षम करें और प्रयास करें: mul
//webMARS argv[0] पहला आपूर्ति किया गया टोकन है, निष्पादन योग्य नाम नहीं।
