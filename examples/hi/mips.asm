...
#mips_os_lib.asm TTY ड्राइवर, ANSI नियंत्रण, स्ट्रिंग्स, पूर्णांक
#mips_os_fs.asm लिखने योग्य RAM फ़ाइल सिस्टम और उसके आदेश
#mips_os_apps.asm कैलकुलेटर, बैनर, कैलेंडर, गेम्स
#mips_os_edit.asm पूर्ण स्क्रीन पाठ संपादक
#mips_os_शीट.asm पूर्ण स्क्रीन स्प्रेडशीट
#mips_os_basic.asm पंक्ति क्रमांकित पूर्णांक BASIC दुभाषिया
#mips_os_desktop.asm माउस चालित प्रोग्राम मैनेजर और विंडोज़
#mips_os_kernel.asm बूट, शेल और सिस्टम कमांड
...
#---- बूट समय डिस्क छवि ----
#प्रत्येक ब्लॉक नंगे न्यूलाइन का उपयोग करता है: RAM डिस्क सादे पाठ को संग्रहीत करती है और
#कंसोल ड्राइवर वह है जो रास्ते में एक नई लाइन को सीआर प्लस एलएफ में बदल देता है।
