# Keyboard and Display MMIO Simulator demo
# Open Tools > Keyboard and Display MMIO Simulator
# Type in the lower keyboard area; characters are echoed to upper display area.
...
mmio_loop:
  # wait keyboard receiver ready (bit0 @ 0x0000)
wait_rx:
  lbu  $t0, 0x0000($s0)
  andi $t0, $t0, 1
  beq  $t0, $zero, wait_rx
  ...
  # wait display transmitter ready (bit0 @ 0x0008)
wait_tx:
  lbu  $t2, 0x0008($s0)
  andi $t2, $t2, 1
  beq  $t2, $zero, wait_tx
