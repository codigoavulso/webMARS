#MARS-OS 1.0 – eine vollständig interaktive TTY Betriebsumgebung
#Öffnen Sie Extras > TTY Gerät + ANSI Terminal, stellen Sie eine Verbindung zu MIPS her,
#zusammenbauen und ausführen; Es öffnet den Mausdesktop. Starten Sie Terminal für die Shell.
#
#Diese Datei enthält nur den lokalisierten Text. Der Kernel selbst lebt darin
#Die unten enthaltenen sprachneutralen Module:
#mips_os_lib.asm TTY Treiber, ANSI Steuerung, Strings, Ganzzahlen
#mips_os_fs.asm beschreibbares RAM Dateisystem und seine Befehle
#mips_os_apps.asm Rechner, Banner, Kalender, Spiele
#mips_os_edit.asm Vollbild-Texteditor
#mips_os_sheet.asm Vollbild-Tabelle
#mips_os_basic.asm Zeilennummerierter Ganzzahl-Interpreter BASIC.
#mips_os_desktop.asm mausgesteuerter Programmmanager und Windows
#mips_os_kernel.asm Boot-, Shell- und Systembefehle
...
#---- Fenster-Desktop ----
#Menüleistentitel und Menüeinträge. Auf dem Desktop sind die Menüs angeordnet
#diese Zeichenfolgen, sodass eine längere Übersetzung das Menü nur breiter macht.
...
#Fenstertitel, indiziert nach Fenstertyp.
...
#---- Startzeit-Disk-Image ----
#Jeder Block verwendet bloße Zeilenumbrüche: Die Festplatte RAM speichert Klartext und die
#Der Konsolentreiber ist es, der eine neue Zeile auf dem Weg nach draußen in CR plus LF umwandelt.
