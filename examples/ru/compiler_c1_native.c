...
//Требуется C1-NATIVE: собственный argc/argv, массивы символов с байтовой адресацией.
//и вызывает через указатель на функцию.
//Включите аргументы программы в настройках и попробуйте: mul
//webMARS argv[0] — это первый предоставленный токен, а не имя исполняемого файла.
