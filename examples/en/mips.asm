...
# assemble and run; it opens the mouse desktop. Launch Terminal for the shell.
#
...
# ---- windowed desktop ----
# Menu bar titles and menu entries. The desktop lays the menus out from
# these strings, so a longer translation only makes the menu wider.
...
# Window titles, indexed by window kind.
