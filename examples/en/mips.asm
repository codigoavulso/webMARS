# MARS-OS 1.0 - a complete interactive TTY operating environment
# Open Tools > TTY Device + ANSI Terminal, connect to MIPS,
# assemble this project and type "desktop" for the mouse UI or "help".
#
# This file holds the localized text only. The kernel itself lives in
# the language neutral modules included at the bottom:
#   mips_os_lib.asm    TTY driver, ANSI control, strings, integers
#   mips_os_fs.asm     writable RAM filesystem and its commands
#   mips_os_apps.asm   calculator, banner, calendar, games
#   mips_os_edit.asm   full screen text editor
#   mips_os_sheet.asm  full screen spreadsheet
#   mips_os_basic.asm  line numbered integer BASIC interpreter
#   mips_os_desktop.asm mouse driven Program Manager and windows
#   mips_os_kernel.asm boot, shell and system commands
...
desktop_task: .asciiz "MARS-OS Program Manager"
...
desktop_label_sheet: .asciiz "Spreadsheet"
desktop_label_basic: .asciiz "BASIC"
desktop_label_about: .asciiz "About"
desktop_hint: .asciiz "Click an icon or Start. Keys: T terminal, E editor, W sheet, B BASIC, Q exit."
desktop_menu_header: .asciiz "| MARS-OS 95             |"
desktop_menu_terminal: .asciiz "| Terminal               |"
desktop_menu_editor: .asciiz "| Text editor            |"
desktop_menu_sheet: .asciiz "| Spreadsheet            |"
desktop_menu_basic: .asciiz "| BASIC                  |"
desktop_menu_about: .asciiz "| About                  |"
desktop_menu_exit: .asciiz "| Restart desktop        |"
desktop_welcome: .asciiz "Welcome to the mouse driven MARS-OS desktop."
desktop_welcome_detail: .asciiz "The window manager and applications run entirely in MIPS assembly."
desktop_help_text: .asciiz "\r\ndesktop UI\r\n  MARS-OS starts in Program Manager; open Terminal for shell commands\r\n  exit | desktop          close Terminal and return to the desktop\r\n                         click Start, icons, windows and spreadsheet cells\r\n"

# ---- boot time disk image ----
# Every block uses bare newlines: the RAM disk stores plain text and the
# console driver is what turns a newline into CR plus LF on the way out.
