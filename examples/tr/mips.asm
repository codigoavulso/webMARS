#MARS-OS 1.0 - eksiksiz bir etkileşimli TTY işletim ortamı
#Araçlar > TTY Cihaz + ANSI Terminalini açın, MIPS'ye bağlanın,
#toplayın ve çalıştırın; fare masaüstünü açar. Kabuk için Terminali başlatın.
#
#Bu dosya yalnızca yerelleştirilmiş metni içerir. Çekirdeğin kendisi yaşıyor
#altta bulunan dil nötr modülleri:
#mips_os_lib.asm TTY sürücüsü, ANSI kontrolü, dizeler, tamsayılar
#mips_os_fs.asm yazılabilir RAM dosya sistemi ve komutları
#mips_os_apps.asm hesap makinesi, banner, takvim, oyunlar
#mips_os_edit.asm tam ekran metin düzenleyicisi
#mips_os_sheet.asm tam ekran e-tablosu
#mips_os_basic.asm satır numaralı tamsayı BASIC yorumlayıcısı
#mips_os_desktop.asm fareyle çalıştırılan Program Yöneticisi ve pencereler
#mips_os_kernel.asm önyükleme, kabuk ve sistem komutları
...
#---- pencereli masaüstü ----
#Menü çubuğu başlıkları ve menü girişleri. Masaüstü menüleri düzenler
#bu dizeler, dolayısıyla daha uzun bir çeviri yalnızca menüyü genişletir.
...
#Pencere türüne göre indekslenen pencere başlıkları.
...
#---- önyükleme zamanı disk görüntüsü ----
#Her blokta çıplak yeni satırlar kullanılır: RAM diski düz metni depolar ve
#konsol sürücüsü, çıkışta yeni satırı CR artı LF'ye dönüştüren şeydir.
