...
#mips_os_lib.asm pilote TTY, contrôle ANSI, chaînes, entiers
#Système de fichiers RAM inscriptible mips_os_fs.asm et ses commandes
#mips_os_apps.asm calculatrice, bannière, calendrier, jeux
#mips_os_edit.asm éditeur de texte plein écran
#mips_os_sheet.asm feuille de calcul plein écran
#mips_os_basic.asm interpréteur de lignes entières numérotées BASIC
#mips_os_desktop.asm Gestionnaire de programmes piloté par la souris et Windows
#mips_os_kernel.asm commandes de démarrage, shell et système
...
#---- image disque au démarrage ----
#Chaque bloc utilise des nouvelles lignes nues : le disque RAM stocke le texte brut et le
#le pilote de console est ce qui transforme une nouvelle ligne en CR plus LF à la sortie.
