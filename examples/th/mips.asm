#MARS-OS 1.0 - สภาพแวดล้อมการทำงาน TTY แบบโต้ตอบที่สมบูรณ์
#เปิดเครื่องมือ > TTY อุปกรณ์ + ANSI เทอร์มินัล เชื่อมต่อกับ MIPS,
#ประกอบและวิ่ง; มันเปิดเดสก์ท็อปเมาส์ เปิด Terminal สำหรับเชลล์
#
#ไฟล์นี้เก็บเฉพาะข้อความที่แปลแล้วเท่านั้น เคอร์เนลนั้นอาศัยอยู่
#โมดูลภาษาที่เป็นกลางรวมอยู่ที่ด้านล่าง:
#mips_os_lib.asm TTY ไดรเวอร์, การควบคุม ANSI, สตริง, จำนวนเต็ม
#mips_os_fs.asm ระบบไฟล์ RAM แบบเขียนได้และคำสั่งของมัน
#mips_os_apps.asm เครื่องคิดเลข แบนเนอร์ ปฏิทิน เกม
#mips_os_edit.asm โปรแกรมแก้ไขข้อความแบบเต็มหน้าจอ
#mips_os_sheet.asm สเปรดชีตแบบเต็มหน้าจอ
#mips_os_basic.asm บรรทัดเลขจำนวนเต็ม BASIC ล่าม
#mips_os_desktop.asm ตัวจัดการโปรแกรมและ windows ที่ขับเคลื่อนด้วยเมาส์
#mips_os_kernel.asm คำสั่งบูต, เชลล์และคำสั่งระบบ
...
#---- เดสก์ท็อปที่มีหน้าต่าง ----
#ชื่อแถบเมนูและรายการเมนู เดสก์ท็อปจะวางเมนูต่างๆ ออกมา
#สตริงเหล่านี้ ดังนั้นการแปลที่ยาวขึ้นจะทำให้เมนูกว้างขึ้นเท่านั้น
...
#ชื่อหน้าต่าง จัดทำดัชนีตามประเภทหน้าต่าง
...
#---- อิมเมจดิสก์เวลาบูต ----
#ทุกบล็อกใช้บรรทัดใหม่เปล่า: ดิสก์ RAM เก็บข้อความธรรมดาและ
#ไดรเวอร์คอนโซลคือสิ่งที่เปลี่ยนบรรทัดใหม่เป็น CR บวก LF ในทางออก
