#MARS-OS 1.0 - môi trường điều hành tương tác hoàn chỉnh TTY
#Mở Công cụ > TTY Thiết bị + ANSI Thiết bị đầu cuối, kết nối với MIPS,
#lắp ráp và chạy; nó mở màn hình chuột. Khởi chạy Terminal cho shell.
#
#Tệp này chỉ chứa văn bản được bản địa hóa. Bản thân hạt nhân sống trong
#các mô-đun trung lập ngôn ngữ được bao gồm ở phía dưới:
#trình điều khiển mips_os_lib.asm TTY, điều khiển ANSI, chuỗi, số nguyên
#hệ thống tập tin mips_os_fs.asm có thể ghi RAM và các lệnh của nó
#máy tính mips_os_apps.asm, biểu ngữ, lịch, trò chơi
#mips_os_edit.asm trình soạn thảo văn bản toàn màn hình
#bảng tính toàn màn hình mips_os_sheet.asm
#trình thông dịch số nguyên được đánh số dòng mips_os_basic.asm BASIC
#mips_os_desktop.asm Trình quản lý chương trình và cửa sổ điều khiển bằng chuột
#Các lệnh khởi động, shell và hệ thống mips_os_kernel.asm
...
#---- máy tính để bàn có cửa sổ ----
#Tiêu đề thanh menu và các mục menu. Máy tính để bàn đưa ra các menu từ
#những chuỗi này, do đó bản dịch dài hơn chỉ làm cho menu rộng hơn.
...
#Tiêu đề cửa sổ, được lập chỉ mục theo loại cửa sổ.
...
#---- hình ảnh đĩa thời gian khởi động ----
#Mỗi khối chỉ sử dụng các dòng mới: đĩa RAM lưu trữ văn bản thuần túy và
#trình điều khiển bảng điều khiển là thứ biến một dòng mới thành CR cộng với LF trên đường ra ngoài.
