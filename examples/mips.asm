...
#
# 1. Open Tools > TTY Device + ANSI Terminal.
# 2. Connect the tool to MIPS.
# 3. Assemble and run this project.
#
# The shell uses keyboard/display MMIO directly. No Bitmap tool
# is required. Type "help" after the system finishes booting.
# ============================================================
...
clock_timer_prefix: .asciiz "timer counter / period: "
clock_separator: .asciiz " / "
clock_uptime_prefix: .asciiz "clock simulated uptime: "
