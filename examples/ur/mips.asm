#MARS-OS 1.0 - ایک مکمل انٹرایکٹو TTY آپریٹنگ ماحول
#ٹولز کھولیں > TTY ڈیوائس + ANSI ٹرمینل، MIPS سے جڑیں،
#جمع اور چلائیں؛ یہ ماؤس ڈیسک ٹاپ کو کھولتا ہے۔ شیل کے لیے ٹرمینل لانچ کریں۔
#
#یہ فائل صرف مقامی متن رکھتی ہے۔ دانا خود ہی رہتا ہے۔
#لینگویج نیوٹرل ماڈیول نیچے شامل ہیں:
#mips_os_lib.asm TTY ڈرائیور، ANSI کنٹرول، سٹرنگز، انٹیجرز
#mips_os_fs.asm قابل تحریر RAM فائل سسٹم اور اس کے کمانڈز
#mips_os_apps.asm کیلکولیٹر، بینر، کیلنڈر، گیمز
#mips_os_edit.asm فل سکرین ٹیکسٹ ایڈیٹر
#mips_os_sheet.asm فل سکرین اسپریڈشیٹ
#mips_os_basic.asm لائن نمبر والے عدد عدد BASIC مترجم
#mips_os_desktop.asm ماؤس سے چلنے والا پروگرام مینیجر اور ونڈوز
#mips_os_kernel.asm بوٹ، شیل اور سسٹم کمانڈز
...
#---- ونڈو والا ڈیسک ٹاپ ----
#مینو بار کے عنوانات اور مینو اندراجات۔ ڈیسک ٹاپ مینو کو باہر رکھتا ہے۔
#یہ سٹرنگز، لہذا ایک لمبا ترجمہ صرف مینو کو وسیع تر بناتا ہے۔
...
#ونڈو ٹائٹلز، ونڈو قسم کے حساب سے ترتیب شدہ۔
...
#---- بوٹ ٹائم ڈسک امیج ----
#ہر بلاک میں نئی لائنیں استعمال ہوتی ہیں: RAM ڈسک سادہ متن اور
#کنسول ڈرائیور وہ ہے جو راستے میں ایک نئی لائن کو CR پلس LF میں بدل دیتا ہے۔
