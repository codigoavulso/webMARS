#MARS-OS 1.0 - kompletne interaktywne środowisko operacyjne TTY
#Otwórz Narzędzia > TTY Urządzenie + ANSI Terminal, połącz się z MIPS,
#zmontuj i uruchom; otwiera pulpit myszy. Uruchom Terminal dla powłoki.
#
#Ten plik zawiera tylko zlokalizowany tekst. Samo jądro żyje
#moduły neutralne językowo zawarte na dole:
#mips_os_lib.asm TTY sterownik, ANSI kontrola, stringi, liczby całkowite
#mips_os_fs.asm zapisywalny RAM system plików i jego polecenia
#mips_os_apps.asm kalkulator, baner, kalendarz, gry
#pełnoekranowy edytor tekstu mips_os_edit.asm
#pełnoekranowy arkusz kalkulacyjny mips_os_sheet.asm
#mips_os_basic.asm liczba całkowita o numerze linii BASIC interpreter
#mips_os_desktop.asm Menedżer programów i okna sterowane myszą
#mips_os_kernel.asm Polecenia rozruchu, powłoki i systemu
...
#---- Pulpit z okienkiem ----
#Tytuły pasków menu i wpisy menu. Na pulpicie znajdują się menu
#te ciągi, więc dłuższe tłumaczenie tylko poszerza menu.
...
#Tytuły okien indeksowane według rodzaju okien.
...
#---- Obraz dysku podczas uruchamiania ----
#Każdy blok używa czystych znaków nowej linii: dysk RAM przechowuje zwykły tekst, a
#sterownik konsoli jest tym, co zamienia nową linię w CR plus LF na wyjściu.
